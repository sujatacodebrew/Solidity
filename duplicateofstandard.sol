...
contract CrowdsaleToken is StandardToken, Configurable {
    string public name = "Tokenizer";
    string public symbol = "TZR";
    ...
    function buyTokens() external payable {
        ...
        bought(owner,weiAmount);// Send money to owner
    }
    
    function bought(address payable _address,uint _value) private{
